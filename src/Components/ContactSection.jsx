            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:thengleapp@gmail.com"
                    className="text-muted-foreground hover:text-primary transition-colors"
                    aria-label="Send email to thengleapp@gmail.com"
                  >
                    thengleapp@gmail.com
                  </a>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    href="tel:+855717736775"
                    className="text-muted-foreground hover:text-primary transition-colors"
                    aria-label="Call +855 71 773 677 5"
                  >
                    +855 71 773 677 5
                  </a>
                </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-muted-foreground hover:text-primary transition-colors"
                    aria-label="View Phnom Penh, Cambodia on Google Maps"
                  >
                    Phnom Penh, Cambodia
                  </a>
                </div>
